    ...
    void klik(){
        imbHome.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intentHome = new Intent(UserActivity.this, MainActivity.class);
        ...
        imbStore.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intentKategori = new Intent(UserActivity.this, StoreActivity.class);
        ...
        imbTopup.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intentTas = new Intent(UserActivity.this, TopupActivity.class);
        ...
        imbJoin.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intentWishlist = new Intent(UserActivity.this, JoinActivity.class);
        ...
        imbUser.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intentWishlist = new Intent(UserActivity.this, UserActivity.class);
                startActivity(intentWishlist);
            }
        });
    }
